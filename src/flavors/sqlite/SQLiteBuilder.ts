    ...
    >
{
  ...
  delete(
    table: string,
    callbackOrWhere: TWhereBuilderCallback<WhereBuilder> | string = ''
  ): Promise<[ResultSet]> {
  ...
  select(
    selectBuilderCallback: TSelectBuilderCallback<WhereBuilder, SelectBuilder>,
    isSubquery = false
  ): Promise<[ResultSet]> {
  ...
  update(
    tableName: string,
    updateCallback: TUpdateBuilderCallback<WhereBuilder, UpdateBuilder>
  ): Promise<[ResultSet]> {
...
const sqlBuilder = new SQLiteBuilder()

export { sqlBuilder, SQLiteBuilder }
